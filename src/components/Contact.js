        ...
        <Box className={classes.box}>
            ...
            <Grid container direction={isDesktop ? "row" : "column"}>
                ...
                <Grid item className={classes.gridItem}>
                    ...
                    <Typography className={classes.content} variant="h6" align="left" gutterBottom>
                        +886961100735
                    </Typography>
                </Grid>
                ...
                <Grid item className={classes.gridItem}>
                    ...
                    <Typography className={classes.content} variant="h6" align="left" gutterBottom>
                        <Link href="https://www.linkedin.com/in/ervinsamuel/" target="_blank" color="inherit">
                ...
                <Grid item className={classes.gridItem}>
                    ...
                    <Typography variant="h6" align="left" gutterBottom>
                        <Link className={classes.content} href="https://github.com/ervsam" target="_blank" color="inherit">
                            github.com/ervsam
                        </Link>
                    </Typography>
                </Grid>
